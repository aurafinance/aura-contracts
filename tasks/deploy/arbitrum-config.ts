...
const extConfig: ExtSidechainConfig = {
    ...
    lzEndpoint: "0x3c2269811836af69497E5F486A85D7316753cf62", // https://docs.layerzero.network/v1/developers/evm/technical-reference/mainnet/mainnet-addresses#arbitrum
...
export const getSidechain = (signer: Signer | Provider) => ({
    ...
    auraBalVaultAuraRewards: VirtualBalanceRewardPool__factory.connect(
        "0x14b820F0F69614761E81ea4431509178dF47bBD3",
        signer,
    ),
...
const getSafeModules = (signer: Signer | Provider) => ({
    extraRewardStashModule: ExtraRewardStashModule__factory.connect(
        "0x81054Eb2dA118651aD41BF5CA7404440A018b681",
        signer,
    ),
});
