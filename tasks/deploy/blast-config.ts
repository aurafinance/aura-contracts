...
const extConfig: ExtSidechainConfig = {
    ...
    lzEndpoint: "0xb6319cC6c8c27A8F5dAF0dD3DF91EA35C4720dd7", // https://docs.layerzero.network/v1/developers/evm/technical-reference/mainnet/mainnet-addresses#blast
    minter: ZERO_ADDRESS,
    token: ZERO_ADDRESS,
