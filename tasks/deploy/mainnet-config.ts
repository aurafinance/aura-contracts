...
const distroList = {
    ...
    vesting: [
        // 4 MONTHS - 0.036%
        {
            ...
            recipients: [
                { address: "0xaf3824e8401299B25C4D59a8a035Cf9312a3B454", amount: simpleToExactAmount(0.02, 24) }, // Contractor 1
        ...
        // 6 MONTHS - 0.0825% + 0.9415% future team
        {
            ...
            recipients: [
                ...
                { address: "0x64A20C56Aa5d41B81e977d0D9724cf41699c2D4E", amount: simpleToExactAmount(0.015, 24) }, // Contractor 5
                { address: multisigs.vestingMultisig, amount: simpleToExactAmount(0.9415, 24) }, // Vesting dao - future team
            ],
        },
        // 24 MONTHS - 8.94%
        {
            ...
            recipients: [
                ...
                { address: "0xe3B6c287C1369C6A4fa8d4e857813695C52948EF", amount: simpleToExactAmount(0.075, 24) }, // Core team 9
                { address: "0xcc6548f1b572968f9539d604ec9ff4b933c1be74", amount: simpleToExactAmount(0.075, 24) }, // Core team 10
                { address: DEAD_ADDRESS, amount: simpleToExactAmount(0.04, 24) }, // Core team 11 // TODO: Add addr
            ],
        },
    ],
};
