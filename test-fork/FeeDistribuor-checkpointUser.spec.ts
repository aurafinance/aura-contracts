...
import { BN, getTimestamp, impersonateAccount, increaseTimeTo, ONE_DAY } from "../test-utils";
...
describe("feeDistributor", () => {
    ...
    it("test future", async () => {
        ...
        await increaseTimeTo(now.add(ONE_DAY));
        ...
        console.log("🚀 ~ file: FeeDistribuor-checkpointUser.spec.ts ~ line 176 ~ it ~ feeDistro.distro", feeDistro.rewards, cvxCrvRewardsAddress)
