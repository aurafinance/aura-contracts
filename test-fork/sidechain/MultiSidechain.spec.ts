...
describe("Multi Sidechain AURA", () => {
    ...
    before(async () => {
        ...
        // LayerZero setup
        await setTrustedRemoteCanonicalPhase1(canonical, sidechain__0, L2_CHAIN_ID__0);
        await setTrustedRemoteCanonicalPhase1(canonical, sidechain__1, L2_CHAIN_ID__1);
